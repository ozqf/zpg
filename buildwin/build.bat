...
@echo --------------------------------------------------------
@echo Build ZPG windows

set BUILD_WIN_DIR=buildwintemp
...
set compInput_1=../src/zpg/zpg_data/zpg_data.cpp ../src/zpg/zpg_entities/zpg_entities.cpp
